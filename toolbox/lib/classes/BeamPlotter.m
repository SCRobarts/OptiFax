classdef BeamPlotter < matlab.mixin.Copyable 
	...
	methods
		function obj = BeamPlotter(cav,src,sig_lam)
			arguments
				cav
				src
				sig_lam = src.Wavelength;
			end
			%BEAMPLOTTER Construct an instance of this class
			%   Detailed explanation goes here
			obj.System = cav;
			obj.Source = src;
			obj.Beam = obj.Source.copy;
			obj.Beam.Wavelength = sig_lam;
			obj.Pump.Z = 0;
		...
		function plot(obj)
			...
			plot(obj.Pump.Z,[obj.Pump.Radius(:,1).*1e3,-obj.Pump.Radius(:,2).*1e3],LineWidth=1);
			hold on
