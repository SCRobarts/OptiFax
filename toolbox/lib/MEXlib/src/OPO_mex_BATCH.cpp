                 ...
                 int nrhs, mxArray const *prhs[])
{
    ...
    mxGPUArray *A0, *A1, *NL, *K1, *K2, *E, *Ap, *stepmods;// *EFT;
	float sel; 
    float const *d_beta_op, *d_alpha_w, *d_G;
    float2  *d_A0, *d_A1, *d_NL, *d_K1, *d_K2, *d_E, *d_Ap;// *d_EFT;
	float w0, h, max_pct_err, min_pct_err, *d_stepmods;
    double bdiffw0, dt;
    int Npoints, Nsteps, Nbatches;
    ...
    */
    ...
    // Call .cu function
 OPO_TEST_CUDA(d_E, d_A0, d_A1, d_NL, d_K1, d_K2, d_G, d_alpha_w,
